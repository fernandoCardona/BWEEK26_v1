                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-12 md:space-y-0 text-center md:text-left">
                    ...
                    <div className="flex space-x-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-gray-500">
                                <li><a href="#" className="link-hover-gradient">Privacidad</a></li>
                                <li><a href="#" className="link-hover-gradient">Términos</a></li>
                                <li><a href="#" className="link-hover-gradient">Cookies</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
