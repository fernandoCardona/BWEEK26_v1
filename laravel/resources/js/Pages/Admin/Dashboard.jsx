                ...
                <div className="container mx-auto">
                    ...
                    >
                        <div>
                            ...
                            <p className="text-gray-400 font-medium">Bears Week 2026 • Live Monitoring</p>
                        </div>
                        <div className="flex bg-white/5 p-1 rounded-xl border border-white/10">
                            {['overview', 'ecommerce', 'ai_training'].map((tab) => (
                                <button
                                    key={tab}
                                    onClick={() => setActiveTab(tab)}
                                    className={`px-6 py-2 rounded-lg text-xs font-bold uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-accent-primary text-white shadow-lg shadow-accent-primary/20' : 'text-gray-500 hover:text-white'
                                        }`}
                                >
                                    {tab.replace('_', ' ')}
                                </button>
                    ...
                    {/* Additional tabs logic would go here */}
                </div>
        </AdminLayout>
    );
}
