...
export default function Edit() {
    ...
    const layoutProps =
        role === 'user'
            ? { active: 'settings', headTitle: 'Mi cuenta • Settings', subtitle: 'Preferencias y seguridad' }
            : { active: 'settings', headTitle: 'Admin • Settings', subtitle: 'Perfil y seguridad' };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-8">
                    <div className="glass-card p-6">
                        ...
                        <p className="text-sm text-gray-400 mb-6">Te enviaremos un email con un enlace seguro para cambiar tu contraseña.</p>
                    ...
                    <div className="glass-card p-6">
                        <h2 className="text-xl font-bold mb-3">Eliminar cuenta</h2>
                        <p className="text-sm text-gray-400 mb-6">Esta acción es permanente. Perderás el acceso a tu cuenta y tus datos asociados.</p>
                        <button
                            type="button"
